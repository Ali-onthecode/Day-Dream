...
@onready var health_bar: ProgressBar = $"../CanvasLayer/Control/HBoxContainer/VBoxContainer/HB_Bar_P2"

# --- Health + Spawn ---
@export var max_health: int = 100
var health: int
@export var spawn_point: NodePath  # set this to "SpawnP2" in the Inspector
